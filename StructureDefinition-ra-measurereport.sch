...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MeasureReport">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/measurereport-category']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/measurereport-category': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MeasureReport/f:extension/f:value[x]/f:coding 1</sch:title>
    <sch:rule context="f:MeasureReport/f:extension/f:value[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MeasureReport/f:group">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/davinci-ra/StructureDefinition/ra-ccType']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/us/davinci-ra/StructureDefinition/ra-ccType': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MeasureReport/f:evaluatedResource</sch:title>
