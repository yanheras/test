...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MeasureReport">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/davinci-ra/StructureDefinition/ra-payerCodingGapReportId']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/davinci-ra/StructureDefinition/ra-payerCodingGapReportId': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/davinci-ra/StructureDefinition/ra-reportingVendor']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/davinci-ra/StructureDefinition/ra-reportingVendor': maximum cardinality of 'extension' is 1</sch:assert>
