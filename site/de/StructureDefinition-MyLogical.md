...
## Logisches Modell: My Logical Model 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/example.fhir.uv.myig|current/StructureDefinition/MyLogical)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-MyLogical.csv), [Excel](../StructureDefinition-MyLogical.xlsx) 
