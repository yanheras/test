# Patch Example01 with multiple value (ra-measurereport01) - Da Vinci Risk Adjustment Implementation Guide v3.0.0-ballot

## Example Parameters: Patch Example01 with multiple value (ra-measurereport01)
