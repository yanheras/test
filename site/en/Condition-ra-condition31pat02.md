# Condition31Pat02: Typical atrial flutter - Da Vinci Risk Adjustment Implementation Guide v3.0.0-ballot

## Example Condition: Condition31Pat02: Typical atrial flutter
...
**code**: I48.3: Typical atrial flutter
...
```json
{
  ...
  "meta" : {
    "extension" : [{
      ...
      "valueString" : "Condition31Pat02: Typical atrial flutter"
    },
    {
      "url" : "http://hl7.org/fhir/StructureDefinition/instance-description",
      "valueMarkdown" : "This is a Condition example with code I48.3: Typical atrial flutter."
    }],
  ...
  "code" : {
    ...
    "text" : "I48.3: Typical atrial flutter"
  },
  "subject" : {
