# Resource Your User Friendly Name for MyIG Here
...
```json
{
  ...
  "packageId" : "example.fhir.uv.myig",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      "extension" : [{
        "url" : "code",
        "valueString" : "fcp-approved-specification"
      },
      {
        "url" : "value",
        "valueString" : "false"
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://somewhere.org/fhir/uv/myig/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      "extension" : [{
        "url" : "code",
        "valueCode" : "fcp-approved-specification"
      },
      {
        "url" : "value",
        "valueString" : "false"
    ...
    "resource" : [{
      ...
      "name" : "My Favorite Patient Profile",
      "description" : "Overriding description because we can"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/MyLogical"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Library/example-image"
      },
      "name" : "Example Library Image",
      "description" : "A test image example"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-example-actor",
        "valueCanonical" : "http://somewhere.org/fhir/uv/myig/ActorDefinition/example"
      },
      {
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
        "valueString" : "Patient"
      ...
      "name" : "Simple patient example",
      "description" : "A simple example showing how examples are defined and referenced",
      "exampleCanonical" : "http://somewhere.org/fhir/uv/myig/StructureDefinition/mypatient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Observation patient example",
      "description" : "Example showing slicing",
      "exampleCanonical" : "http://somewhere.org/fhir/uv/myig/StructureDefinition/myObservation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Binary/logical-example"
      },
      "name" : "Example of Logical Model",
      "description" : "Example showing example content for a logical model",
      "exampleCanonical" : "http://somewhere.org/fhir/uv/myig/StructureDefinition/MyLogical"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-resource-format",
      ...
      "reference" : {
        "reference" : "Binary/image-example"
      },
      "name" : "Example of Binary Image",
      "description" : "Example showing example content for an image"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "ValueSet/valueset-no-codesystem"
      },
      "name" : "Value set for no code system",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ActorDefinition/example"
      },
      "name" : "Example Server",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/ext-myExtension"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/cs-fake"
      },
      "name" : "CodeSystem fake",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/valueset-fake"
      },
      "name" : "ValueSet fake",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/mypractitioner"
      },
      "name" : "MyPractitionerName",
      "description" : "Description for the profile page",
      "groupingId" : "resources-spreadsheet.xml"
    }],
    "page" : {
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/structuredefinition-standards-status",
