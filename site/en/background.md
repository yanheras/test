# Background - Da Vinci Risk Adjustment Implementation Guide v3.0.0-ballot
...
**Figure 1-1 Medicare Advantage Risk Adjustment Cadence**
![](payment-cycle-overlap.png)
...
* For Security, see [Security, Privacy, and Safety](security.md)
...
![](workflow-medicare-advantage.png)
...
* Reporting Client 
* Payer plays this role when they request a [Risk Adjustment Coding Gap Report](StructureDefinition-ra-measurereport.md) to POST to Provider's FHIR Server
...
* Provider plays this role when they create a [Risk Adjustment Data Exchange MeasureReport](StructureDefinition-ra-datax-measurereport.md) and submit to Payer
