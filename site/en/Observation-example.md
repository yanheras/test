...
## Example Observation: Observation patient example
...
> **component****code**: Systolic blood pressure**value**: 1 mm[Hg] (Details: UCUM codemm[Hg] = 'mm[Hg]')

> **component****code**: Diastolic blood pressure**value**: 1 mm[Hg] (Details: UCUM codemm[Hg] = 'mm[Hg]')
