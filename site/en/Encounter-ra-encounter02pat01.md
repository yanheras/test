# Encounter with Dr Hippocrates on 2021-01-31 for Patient 03 - Da Vinci Risk Adjustment Implementation Guide v3.0.0-ballot

## Example Encounter: Encounter with Dr Hippocrates on 2021-01-31 for Patient 03
...
**period**: 2021-01-31 --> 2021-01-31

> **diagnosis****condition**: [Condition Diabetes mellitus due to underlying condition with other diabetic kidney complication](Condition-ra-condition02pat01.md)

> **diagnosis****condition**: [Condition Body mass index [BMI] 45.0-49.9, adult](Condition-ra-condition17pat01.md)
