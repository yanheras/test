...
## Profil des ressources: My Observation Profile ( Expérimental ) 
...
* Exemples pour ce/t/te Profil: [Observation/example](Observation-example.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/example.fhir.uv.myig|current/StructureDefinition/myObservation)
...
Obligatoire : 2 éléments(6 éléments obligatoire(s) imbriqué(s))
...
**[Maturité](http://hl7.org/fhir/versions.html#maturity)**: 5
...
Autres représentations du profil : [CSV](../StructureDefinition-myObservation.csv), [Excel](../StructureDefinition-myObservation.xlsx), [Schematron](../StructureDefinition-myObservation.sch) 
