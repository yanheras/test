...
* Utilise ce/t/te Extension: [My Favorite Patient Profile](StructureDefinition-mypatient.md)
* Exemples pour ce/t/te Extension: [Patient/example](Patient-example.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/example.fhir.uv.myig|current/StructureDefinition/ext-myExtension)
...
Extension simple avec le type boolean : What this extension means.
...
Autres représentations du profil : [CSV](../StructureDefinition-ext-myExtension.csv), [Excel](../StructureDefinition-ext-myExtension.xlsx), [Schematron](../StructureDefinition-ext-myExtension.sch) 
