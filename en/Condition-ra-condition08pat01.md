# Condition08Pat01: Bipolar disorder, current episode mixed, mild - Da Vinci Risk Adjustment Implementation Guide v3.0.0-ballot

## Example Condition: Condition08Pat01: Bipolar disorder, current episode mixed, mild
...
**code**: F31.61: Bipolar disorder, current episode mixed, mild
...
```json
{
  ...
  "meta" : {
    "extension" : [{
      ...
      "valueString" : "Condition08Pat01: Bipolar disorder, current episode mixed, mild"
    },
    {
  ...
  "code" : {
    ...
    "text" : "F31.61: Bipolar disorder, current episode mixed, mild"
  },
  "subject" : {
