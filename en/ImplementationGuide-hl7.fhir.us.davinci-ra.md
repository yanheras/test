# Resource Da Vinci Risk Adjustment Implementation Guide
...
```json
{
  ...
  "definition" : {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "Bundle/ra-riskgap-data1"
      },
      "name" : "Bundle example for the data parameter of the risk-gap operation",
      "description" : "This is a Bundle example includes referenced resources by parameters of the risk-gap operation.",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      "name" : "QualifyingDxCode Extension",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/ra-temp"
      },
      "name" : "RA Temporary Code System",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/remark-type"
      },
      "name" : "Remark Type",
