# Risk Adjustment MeasureReport Bundle example, MeasureReport01: Patient01 - Da Vinci Risk Adjustment Implementation Guide v3.0.0-ballot
...
```json
{
  ...
  "meta" : {
    ...
    "profile" : ["http://hl7.org/fhir/us/davinci-ra/StructureDefinition/ra-measurereport-bundle"]
  },
  "language" : "en",
  "identifier" : {
